...
import {
  ...
  QUILL_MODULES,
} from "./create-event-sidebar/constants";
import {
  createId,
  formatOverrideDateRange,
  getInitialCustomUnit,
  getInitialCustomValue,
  getInitialDuration,
} from "./create-event-sidebar/helpers";
...
export const CreateEventSidebar: React.FC<CreateEventSidebarProps> = ({
  ...
  const [duration, setDuration] = React.useState(() =>
    getInitialDuration(editingEvent),
  );
  ...
  const [customValue, setCustomValue] = React.useState(() =>
    getInitialCustomValue(editingEvent),
  );
  const [customUnit, setCustomUnit] = React.useState(() =>
    getInitialCustomUnit(editingEvent),
  );
  ...
  const selectedColor =
    EVENT_COLORS.find((c) => c.value === eventColor) || EVENT_COLORS[3];
    ...
    <>
      <SidebarPanel onClose={onClose}>
        <div className="flex h-full min-h-0 flex-col">
          ...
          >
            ...
            <div className="space-y-0 divide-y divide-slate-300">
              {!showMoreOptions ? (
                ...
                <div className="">
                  {/* Description Section */}
                  <div className="py-4 px-6 border-b border-slate-300">
                    <div
                      className="group cursor-pointer"
                      onClick={() => {
                      ...
                      {expandedSection === "Limits and buffers" && (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-slate-500 mb-3">
                              Set the maximum meetings allowed for this event
                              type
                            </p>
                      ...
                      {expandedSection === "Invitee form" && (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="text-xs text-slate-500 mb-3">
                              Collect invitees first name and email, or full
                              name and email
                            </p>
                            ...
                            <div className="border-l-2 border-slate-100 pl-4 py-2 space-y-4">
                              ...
                              <label className="flex items-start gap-3 cursor-pointer group">
                                ...
                                <span className="text-sm text-slate-700">
                                  Autofill Invitee Name, Email, and Text
                                  Reminder Phone Number (when applicable) from
                                  prior bookings
                                </span>
                              </label>
                            </div>
                  ...
                  <div className="py-4 px-6 border-b border-slate-300">
                    <div
                      className="group cursor-pointer"
                      onClick={() =>
                        toggleSection("Notifications and workflows")
                      }
                    >
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-lg font-bold text-slate-900">
                          ...
                          <div className="space-y-3 relative">
                              ...
                              {activeInfoPopup === "workflows" && (
                                ...
                                >
                                  <p className="text-sm leading-relaxed font-medium">
                                    Workflows are automated pre- and
                                    post-meeting emails and texts sent to
                                    invitees or hosts. They're fully
                                    customizable, and can be applied to multiple
                                    events, making them easy to manage and
                                    update.
                                  </p>
                                  <button
                            ...
                            <div className="bg-blue-50/50 border border-blue-200 rounded-xl p-4 flex gap-3">
                              ...
                              <p className="text-sm text-slate-700 leading-relaxed">
                                Only the owner of the event type can make
                                ...
                                >
                                  <div className="space-y-4">
                                    ...
                                    <p className="text-sm leading-relaxed font-medium">
                                      ...
                                      Workflows include additional templates,
                                      and can be sent to invitees and hosts.
                                    </p>
                                  </div>
                                  <button
                                    onClick={() => setActiveInfoPopup(null)}
          ...
          {/* I want the below div to stay locked to the bottom */}
          <div className="shrink-0 px-6 py-4 border-t border-slate-400 flex items-center justify-end gap-4 bg-white">
            <div className="flex items-center gap-4">
              {!showMoreOptions ? (
                <button
